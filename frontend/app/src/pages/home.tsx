...
export default function Home() {
  return (
    <>
      <header className="flex flex-row items-center p-2 text-gray-700 border-b border-gray-200 bg-green-100">
        ...
        <nav className="mx-auto flex flex-row items-center space-between ">
          <a
            href="#home"
            className="mr-5 hover:text-green-500 flex flex-col items-center"
          >
            <svg
              width="30"
              height="30"
        ...
        <Link
          to="/login"
          className="text-white bg-green-500 my-2 py-1 px-2 rounded text-lg hover:bg-green-600 duration-300"
        >
          ログアウト
        </Link>
      </header>

      <h2 className="text-xl bg-yellow-50">Home</h2>
    </>
  );
}
